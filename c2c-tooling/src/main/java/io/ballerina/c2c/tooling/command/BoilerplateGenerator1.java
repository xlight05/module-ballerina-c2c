...
import io.ballerina.c2c.tooling.command.boilerplate.nodes.BoilerplateTable;
import io.ballerina.c2c.tooling.command.boilerplate.nodes.BoilerplateTopLevelNode;
 ...
 * @since 2.0.0
 */
public class BoilerplateGenerator1 extends SchemaVisitor {

    private String parentTableKey;
    private final List<String> output;
    private final List<BoilerplateTopLevelNode> outputNew;
    private String key;

    private static final String NEW_LINE = System.lineSeparator();

    public BoilerplateGenerator1(Schema rootSchema) {
        this.output = new ArrayList<>();
        this.outputNew = new ArrayList<>();
    ...
    public void visit(Schema objectSchema) {
        ...
        if (!isTableHeaderSkippable(children)) {
            outputNew.add(new BoilerplateTable(this.parentTableKey));   
        }
